...
public class WFEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WFEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WFEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WFEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WFEDateTimeConverter dateTimeConverter = new WFEStandardDateTimeConverter();

    public WFEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WFEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WFEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WFEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WFEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WFEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
