...
public class WFEKPSPublicSoap
{
    ...
    public WFEKPSPublicSoap(){}

    public WFEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WFEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WFEExtendedSoapSerializationEnvelope envelope= new WFEExtendedSoapSerializationEnvelope(WFEExtendedSoapSerializationEnvelope.VER11);
