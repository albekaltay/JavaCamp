...
public class VVLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VVLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VVLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VVLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VVLDateTimeConverter dateTimeConverter = new VVLStandardDateTimeConverter();

    public VVLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VVLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VVLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VVLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VVLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VVLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
