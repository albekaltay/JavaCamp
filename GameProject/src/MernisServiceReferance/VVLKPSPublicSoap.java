...
public class VVLKPSPublicSoap
{
    ...
    public VVLKPSPublicSoap(){}

    public VVLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VVLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VVLExtendedSoapSerializationEnvelope envelope= new VVLExtendedSoapSerializationEnvelope(VVLExtendedSoapSerializationEnvelope.VER11);
